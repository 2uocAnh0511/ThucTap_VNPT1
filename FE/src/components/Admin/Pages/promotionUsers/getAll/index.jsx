...
function PromotionList() {
  ...
  const openAddUserModal = async (promotionId) => {
    try {
      const res = await axios.get(`${Constants.DOMAIN_API}/api/users/not-in-promotion`, {
        params: { promotionId },
      });
  ...
  const handleAddUsersToPromotion = async () => {
    ...
    try {
      ...
      await axios.post(`${Constants.DOMAIN_API}/api/promotionusers/add`, {
  ...
  const fetchPromotions = async () => {
    ...
    try {
      const res = await axios.get(`${Constants.DOMAIN_API}/api/promotions/list`);
  ...
  const fetchCustomersByPromotion = async (promotionId) => {
    ...
    try {
      const res = await axios.get(`${Constants.DOMAIN_API}/api/promotionusers/list`, {
        params: { promotionId },
      });
  ...
  const handleSendEmails = async (useDefault = false) => {
    ...
    try {
      await axios.post(`${Constants.DOMAIN_API}/api/send-promotion-emails`, {
