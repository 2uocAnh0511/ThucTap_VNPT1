...
const BlogCreate = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const response = await axios.post(`${Constants.DOMAIN_API}/admin/blog/create`, formData, {
                headers: {
            ...
            <div className="bg-white p-6 rounded-lg shadow-md max-w-full mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data" className="p-4 border rounded-md shadow-lg">
                    ...
                    <div className="mb-4">
                        ...
                        />
                        {errors.short_description && <p className="text-red-500">{errors.short_description.message}</p>}
                    </div>
